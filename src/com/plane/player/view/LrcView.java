...
public class LrcView extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		for (int i = mCurrentLine - 1; i >= 0; i--) {
			...
			canvas.drawText(lrc, x, (mTextSize + mDividerHeight) * i,
					mNormalPaint);
		}
		...
		// 画当前行
		canvas.drawText(currentLrc, currentX, (mTextSize + mDividerHeight)
				* mCurrentLine, mCurrentPaint);
