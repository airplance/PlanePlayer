package com.plane.player.adapter;
...
import com.plane.player.component.dialog.CommonAlertDialogBuilder;
import com.plane.player.component.dialog.PlaylistDialog;
...
public class OnlineSearchAdapter extends BaseAdapter implements
	...
	private List<OnLineAudio> audioList;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.name_tv.setText(audioList.get(position).getFilename());
