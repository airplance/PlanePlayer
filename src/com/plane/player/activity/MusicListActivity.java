...
import com.plane.player.service.SystemService;
import com.plane.player.utils.Constants;
import com.plane.player.utils.DirectoryUtil;
...
public class MusicListActivity extends BaseListActivity {
	...
	private final int getCountPlaylistMediaByName(String name) {
		...
		String[] selectionArgs = {
				this.getIntent().getExtras().get("com.plane.player.pid")
						.toString(), name };
	...
	public void initListAdapter() {
		musicList = audioDao.getAudioListByPlaylistId(this.getIntent()
				.getExtras().get("com.plane.player.pid").toString());
