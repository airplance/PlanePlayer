...
import com.plane.player.adapter.PlaylistAdapter;
import com.plane.player.component.dialog.CreatePlaylistDialog;
import com.plane.player.dao.PlaylistDao;
import com.plane.player.dao.impl.PlaylistDaoImpl;
...
public class PlaylistActivity extends BaseListActivity {
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		toMusicListActivity.putExtra("com.plane.player.pid", id);
