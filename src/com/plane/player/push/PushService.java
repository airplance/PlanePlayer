...
public class PushService extends Service {
	...
	private static final String MQTT_HOST = "120.24.176.41";
	...
	// MQTT broker.
	public static String MQTT_CLIENT_ID = "huang";
	...
	public static void actionSend(String title, String msg) {
		try {
			mConnection.publishToTopic(title, msg);
...
//		String deviceID = mPrefs.getString(PREF_DEVICE_ID, null);
	...
	private void showNotification(String text) {
		...
		n.icon = com.plane.player.R.drawable.btn_check;
